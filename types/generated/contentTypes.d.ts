...
export interface ApiCompanyCompany extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    about: Schema.Attribute.Component<'shared.text-array', true>;
...
export interface ApiJobJob extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    aboutRole: Schema.Attribute.Component<'shared.text-array', true>;
    applications: Schema.Attribute.Relation<
      'oneToMany',
      'api::application.application'
    >;
    benefits: Schema.Attribute.Component<'shared.text-array', true>;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    waysToWork: Schema.Attribute.Component<'shared.text-array', true>;
    whatWeDo: Schema.Attribute.Component<'shared.text-array', true>;
    workplace: Schema.Attribute.Enumeration<['Remote', 'Hybrid', 'On-site']>;
  };
}
